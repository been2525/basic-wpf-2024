...
namespace ex07_EmployeeMngApp.ViewModels
{
    public class MainViewModel : Conductor<object>
    {
        ...
        /// <summary>
        /// Caliburn.Micro가 Xaml의 베턴 x:Name과 동일한 이름의 메서드로 매핑
        /// </summary>
        public async void SaveEmployee()
        {
            ...
            using (SqlConnection conn = new SqlConnection(Helpers.Common.CONNSTRING))
            {
                ...
                SqlParameter prmAddr = new SqlParameter("@Addr", Addr ?? (object)DBNull.Value); // 주소가 빈값을때 컬럼에 null값을 입력
