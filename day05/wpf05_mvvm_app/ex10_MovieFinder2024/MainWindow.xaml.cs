...
namespace ex10_MovieFinder2024
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        {
            string tmdb_apiKey = "d6120e51de0174c447b5f4c69e303c62"; // TMDB사이트에서 제공받은 API키.
            ...
            foreach (var item in jsonArray)
            {
                ...
                {
                    // 프로퍼티라서 대문자 시작, json 자체키는 소문자
                    // Convert.ToBoolean == Booloean.Parse(string)
                    // Convert.ToDoublt() == Double.Pars(string)
